...
Evar <- as.vector(paste0("E", seq(1,200))) ## Should be increased to ncol(E.df)
Evar <- as.vector(paste0("E", seq(1,ncol(E.df)))) 
...
save(mlm, model_basis, nb, sig.lw, dat2, dat3, E.df, file = "covid_sf_phase.RData")
